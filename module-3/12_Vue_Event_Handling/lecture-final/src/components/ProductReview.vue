<template>
  <div class="main">
    ...
    <h4>There are {{reviews.length}} reviews in total. </h4>


    <a href="#" v-if="showForm === false" v-on:click.prevent="showForm = true">Show Form</a>
    <a href="#" v-if="showForm === true" v-on:click.prevent="showForm = false">Hide Form</a>
...
export default {
  ...
  methods: {
    ...
    addNewReview() {
      ...
      this.nextReviewId = this.getNextReviewId();
      this.newReview.id = this.nextReviewId;
