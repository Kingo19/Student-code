...
import com.techelevator.jg.services.PlayerService;
...
public class App {
    ...
    private final PlayerService playerService = new PlayerService(API_BASE_URL);
	...
	private void viewAllPlayers() {
        ...
        //call the Player Client Side service to fetch an array of players
        Player[] players = playerService.fetchListOfPlayers();

        //pass it to the console service
        consoleService.printPlayers(players);
