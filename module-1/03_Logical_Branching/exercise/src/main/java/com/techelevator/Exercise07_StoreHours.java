...
public class Exercise07_StoreHours {
    ...
    public boolean isStoreOpen(int currentHour, char currentDay) {
        return (currentDay == 'M' || currentDay == 'W' || currentDay == 'F') && isStoreOpen(currentHour);
    }
    ...
    public boolean isStoreOpen(int currentHour, char currentDay, boolean isSummer) {
        if (isSummer) {
            return (currentDay == 'S' && currentHour >= 9 || currentHour <= 15 && currentDay == 'W' && currentHour >= 8 || currentHour <=20);
